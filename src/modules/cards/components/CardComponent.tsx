...
export function CardComponent({ card }: CardComponentProps) {
  return (
    ...
    >
      ...
      <div className="relative z-30 h-full w-full flex flex-col justify-between px-8 py-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="font-semibold tracking-widest text-lg text-white drop-shadow-lg">
              {card.userName}
            </p>
          </div>
          <Logo />
        ...
        <div className="flex justify-between items-end pt-4">
          <div>
            ...
            <p className="text-lg font-bold tracking-widest text-green-200 drop-shadow">
      ...
      {/* Reflejo animado superior izquierdo */}
